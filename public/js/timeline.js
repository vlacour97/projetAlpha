$(function(){
    ...
    function pageLoad(){
        ...
        $('#post_file_input').css('display','none');
        $('#add_file_to_post').css('display','block');
    }
    pageLoad();
    SingApp.onPageLoad(pageLoad);

    $('#add_file_to_post').click(function(){
        $(this).fadeOut();
        $('#post_file_input').delay(350).fadeIn();
    });

    $('.like_list').click(function(e){
        console.log(e);
        $("#like_list").modal();
    });
